    ...
    <div className=" text-white text-center ">
      ...
      <div className="flex flex-row items-center justify-center space-x-2 text-white text-sm py-3">
        ...
        <p className="font-light">
          Rise: <span className="font-medium ml-2">07:00 AM</span>
        </p>
        <p className="font-light">|</p>
        <UilSunset />
        <p className="font-light">
          Set: <span className="font-medium ml-2">07:00 AM</span>
        </p>
        <p className="font-light">|</p>
        <UilSun />
        <p className="font-light">
          High: <span className="font-medium ml-2">07:00 AM</span>
        </p>
        <p className="font-light">|</p>
        <UilSun />
        <p className="font-light">
          Low: <span className="font-medium ml-2">07:00 AM</span>
        </p>
        <p className="font-light">|</p>
      </div>
    </div>
