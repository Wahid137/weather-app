...
const WeatherInfo = ({ temperature, refetch }) => {
  ...
  console.log(temperature.coord);
  const url = `https://api.openweathermap.org/data/2.5/onecall?lat=48.8534&lon=2.3488&exclude=current,minutely,hourly,alerts&appid=1fa9ff4126d95b8db54f3897a208e91c&units=metric`;
