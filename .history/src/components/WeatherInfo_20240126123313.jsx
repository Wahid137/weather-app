...
const WeatherInfo = ({ temperature, refetch }) => {
  ...
  return (
    <div className=" text-white text-center ">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center mx-40">
        <div className="flex flex-col mr-10 h-[300px] md:flex-row items-center py-4 lg: justify-around w-1/2 mx-auto my-7 bg-slate-600 bg-opacity-65 rounded">
          <img
            className="w-20"
        ...
        <div className="w-1/2 h-[300px] ms-20">
          <Location />
        </div>
      </div>
